...
const SKILL_LABELS: Record<string, string> = {
  'analyze-characters': '角色分析',
  'analyze-locations': '场景分析',
  'analyze-props': '道具分析',
  'split-clips': '片段切分',
  'generate-screenplay': '剧本生成',
  'plan-storyboard-phase1': '分镜规划',
  'refine-cinematography': '摄影规则',
  'refine-acting': '表演指导',
  'refine-storyboard-detail': '镜头细化',
  'generate-voice-lines': '台词生成',
  insert_panel: '插入分镜',
  panel_variant: '分镜变体',
  regenerate_storyboard_text: '分镜文本重生成',
  modify_shot_prompt: '镜头提示词修改',
}
