...
Run the canonical storyboard generation pipeline for novel-promotion projects. This workflow is fixed-order and serial because each stage depends on artifacts produced by earlier stages.
