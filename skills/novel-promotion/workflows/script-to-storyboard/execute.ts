...
import { buildClipContext, buildProjectContext } from '@skills/novel-promotion/_shared/script-to-storyboard-runtime'
import type { ScriptToStoryboardWorkflowInput, ScriptToStoryboardWorkflowResult } from '@skills/novel-promotion/_shared/script-to-storyboard-types'
import { executeGenerateVoiceLines } from '@skills/novel-promotion/generate-voice-lines/execute'
import { executePlanStoryboardPhase1 } from '@skills/novel-promotion/plan-storyboard-phase1/execute'
import { executeRefineActing } from '@skills/novel-promotion/refine-acting/execute'
import { executeRefineCinematography } from '@skills/novel-promotion/refine-cinematography/execute'
import { executeRefineStoryboardDetail } from '@skills/novel-promotion/refine-storyboard-detail/execute'
...
export async function runScriptToStoryboardWorkflowPackage(
  ...
  const project = buildProjectContext({
    characters: input.novelPromotionData.characters || [],
    locations: input.novelPromotionData.locations || [],
