...
Run the canonical story analysis and screenplay generation pipeline for novel-promotion projects. This workflow is fixed-order and serial because each downstream skill consumes the previous skill's artifact output.
